...
import {
  initLoader,
  saveAdmPromoter as saveConfig,
  updateAdmPromoter as updateConfig,
} from "./admPromoter_slice";
import { Loading } from "../../components/Loading";
import { useRef } from "react";
import { Flex } from "../../components/style/Flex_styled";

export const AdmPromoterModal = ({ add, open, setOpen = () => { }, data }) => {
  ...
  return (
    <>
      <Modal
        ...
        sm={8}
        xs={12}
        title={add ? ("Add Promoter") : ("Update Promoter")}
        open={open}
        onClose={() => {
          setOpen(false);
        }}
