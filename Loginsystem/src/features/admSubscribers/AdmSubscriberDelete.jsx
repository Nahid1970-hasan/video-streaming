...
import {
    deleteSubscriberConfig as deleteConfig,
} from "./adm_subscriber_slice";
import { Flex } from "../../components/style/Flex_styled";
import { useEffect } from "react";

export const AdmSubscriberDelete = ({ open, setOpen = () => { }, data }) => {
    ...
    return <Modal  title={("Delete Subscribers")} xs={4} open={open} onClose={() => {
        setOpen(false);
      }}>
       <Flex row>
            <Flex md ="12">
                {("Are you sure? you want to delete Subscribers?")}
            </Flex>
       </Flex>
        <CardHeaderButton>
            <SecondaryButton
