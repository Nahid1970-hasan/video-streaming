...
export const Button = styled.button`
  ...
  cursor: pointer;
  font-family: ${({ fontFamily, notResize}) => (!!fontFamily ? fontFamily :notResize?"var(--dashboard-font)": "var(--dashboard-font)")};
  font-weight: 400;
  font-size: ${({theme, notResize})=>!!notResize ? theme.fontSize.font : theme.fontSize['font']};
