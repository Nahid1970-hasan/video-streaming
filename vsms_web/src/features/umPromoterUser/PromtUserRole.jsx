...
import { initLoader, selectAllModule, selectModule, selectReadOnly, updatePromtUserRole } from "./um_promoter_user_role_slice";
import { Loading } from "../../components/Loading";
import { Toast } from "../../components/Toast";

export const PromtUserRole = ({ open, setOpen, data }) => {

    const UserRole = useSelector(state => state.umpromtuserrole);
