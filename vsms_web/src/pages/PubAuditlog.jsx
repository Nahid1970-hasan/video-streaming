...
import { loadPubAuditLogData } from "../features/Auditlogs/pub_audit_log_slice";
...
export const PubAuditlog = () => {
    const dispatch = useDispatch();
    const auditLogsData = useSelector((state) => state.pubAuditlog);
    ...
    function loadAuditData(date) {
        ...
        dispatch(loadPubAuditLogData(data));
    }
